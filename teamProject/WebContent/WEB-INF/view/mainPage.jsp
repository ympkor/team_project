...
<head>
	...
	<script type="text/javascript" src="/js/main/mainDetailTest.js"></script>
	<script type="text/javascript" src="/js/main/sideMenu_insert.js"></script>
</head>
			...
			<div class="update_category_container">
				...
				<div id="update_form_container">
					...
					<div class="update_date">
						...
						<input type="date" id="update_income_date" class="update_income_date" name="incomeDate" value="" required="required">
					</div>
					...
					<div class="update_income_amount">
						...
						<input type="number" id="update_income_amount" name="amount" required>
					</div>
					<!-- income_memo 입력 창 -->
					<div class="update_income_memo">
						<label for="update_income_memo">내용</label>
						<input type="text" id="update_income_memo" name="memo">
					</div>
					<!-- 입력하기 버튼 -->
			...
			<form id="update_expense_form" class="hidden">
				...
				<div id="update_form_container">
					...
					<div class="update_expense_amount">
						...
						<input type="number" id="update_expense_amount" name="amount" required>
					</div>
					<!-- income_memo 입력 창 -->
					<div class="update_expense_memo">
						<label for="update_expense_memo">내용</label>
						<input type="text" id="update_expense_memo" name="memo">
					</div>
					<!-- 입력하기 버튼 -->
				...
				<div id="insert_form_container">
					...
					<div class="insert_assets">
						...
						<select id="insert_aom_income" name="memAssetId" required="required">
							<option id="insert_aom_income_selected" value="" selected>선택하세요</option>
						</select>
					...
					<div class="insert_income_amount">
						...
						<input type="number" id="insert_income_amount" name="amount" required>
					</div>
					<!-- income_memo 입력 창 -->
					<div class="insert_income_memo">
						<label for="insert_income_memo">내용</label>
						<input type="text" id="insert_income_memo" name="memo">
					</div>
					<!-- 저장 버튼 -->
			...
			<form id="insert_expense_form">
				<div id="insert_form_container">
					...
					<div class="insert_date">
						...
						<input type="date" id="insert_expense_date" class="insert_expense_date" name="incomeDate" value=""
							required="required">
					</div>
					<!-- assets_id 선택 창. 사용자에겐 자산 명으로 보여주자 -->
					<div class="insert_assets">
					...
					<div class="insert_expense_amount">
						...
						<input type="number" id="insert_expense_amount" name="amount" required>
					</div>
					<!-- income_memo 입력 창 -->
					<div class="insert_expense_memo">
						<label for="insert_expense_memo">내용</label>
						<input type="text" id="insert_expense_memo" name="memo">
					</div>
					<!-- 저장 버튼 -->
		...
		<div class="mainPage_sectionContainer">
			...
			<table>
				<thead>
					<tr>
						...
						<th colspan="5">
							<div>
								<input type="month" id="selecDate" name="selecDate" value=''>
							</div>
						</th>
						<th>
				...
				<tbody id="tbody">
					<tr>
						...
						<c:forEach var="i" begin="1" end="${cal.daysOfMonth[cal.month-1]}">
							<td class="dateTd">
								<div class="dateDiv"><span class="dateSpan">${i}</span>
									<c:choose>
										<c:when test="${i<10}">
											<div class="entry d0${i}"></div>
										</c:when>
										<c:otherwise>
											<div class="entry d${i}"></div>
										</c:otherwise>
									</c:choose>
								</div>
			...
			<c:forEach var="miic" items="${miicList}">
				<script type="text/javascript">
					var entry = document.querySelector('.d${miic.incomeDate.toString().substring(8, 10)}');
			...
			<c:forEach var="meec" items="${meecList}">
				<script type="text/javascript">
					var entry = document.querySelector('.d${meec.expenseDate.toString().substring(8, 10)}');
		...
		<div class="mainPage_detailContainer">
			...
			<c:forEach var="iica" items="${iicaList}">
				...
				<script type="text/javascript">
					...
					str += '<div class=detailIAmount><span class=detailIAmount>${iica.amount}</span></div></div>';
			...
			<c:forEach var="eeca" items="${eecaList}">
				...
				<script type="text/javascript">
					...
					str += '<div class=detailEAmount><span class=detailEAmount>${eeca.amount}</span></div></div>';
